...
class About extends HTMLElement {
    ...
    constructor(){
        ...
        this.innerHTML = `
            ...
            You can search, create, compose multiple instructions/commands and use it in your terminal !<br><br>

            <h5>How it works</h5>
            For example, instead of running a long list of commands to install Docker on Ubuntu :
            ...
            <kbd>
                <small>curl -L -s https://b4sh.co/b.sh | bash -s docker_ubuntu_1swda</small>
            </kbd>
            <hr>
                ...
                <ul>
                    <li>
                        By coding, jump to the
                         <a href="https://github.com/Sanix-Darker/b4sh-api" target="_blank">&lt;source code/&gt;</a>.
                    </li>
                    <li>
                        By motivating with some donations,
